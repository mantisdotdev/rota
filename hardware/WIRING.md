...
- Display: 30 MHz SPI (the driver's default; the panel's datasheet says 10 MHz), rotation 1 (landscape; try 3 if the image is upside down), 60 Hz refresh, vsync spacing 1, diff gap 4.
